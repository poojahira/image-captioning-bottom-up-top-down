...
class Attention(nn.Module):
    ...
    def __init__(self, features_dim, decoder_dim, attention_dim, dropout=0.5):
        ...
        self.features_att = weight_norm(nn.Linear(features_dim, attention_dim))  # linear layer to transform image features
...
class DecoderWithAttention(nn.Module):
    ...
    def forward(self, image_features, encoded_captions, caption_lengths):
        """
        Forward propagation.
        :param image_features: encoded images features, a tensor of dimension (batch_size, 36, features_dim)
        ...
        # Mean pool image features
        image_features_mean = image_features.mean(1).to(device)  # (batch_size, features_dim)
